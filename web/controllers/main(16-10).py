...
class TXTExport(ExportFormat,http.Controller):
    ...
    def from_data(self, fields, rows):
        ...
        for k in range(cant):
            ...
            for x in [-1,-2,-3,-4,-5,-6,-7]:    
                ...
                if monto=="":
                    monto=0
                if x==-5:
                    #if dato!="": # Extrae quien no tenga monto                   
                        L.append(n_trab)                                           
                        total +=monto                        
        ...
        total=str(total).zfill(16).replace(".","")      
        ...
        for y in range(cant):
            ...
            if dato1!="": # Nombre del Trabajador     
                n_trab +=1 
                n_trab=str(n_trab) 
                ...
                if x==-5:
                        ...
                        if veces==0: 
                            ...
                            if freq==1: # En el caso que solo el trabajador tenga un solo monto
                                ...
                                monto=str(monto).zfill(12).replace(".","")                               
                                ...
                                nombre= nombre.translate(str.maketrans('', '', quitar)) #quita char especiales del nombre      
                                fp.write(nac+cedula+cuenta+monto+nombre+'\n')                               
                                monto=0 # reset monto para nuevo trabajador   
