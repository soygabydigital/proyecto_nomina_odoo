...
class HrPayslip(models.Model):
    ...
    # * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    #sumatoria_salario=fields.Integer(devengado='_sumatoria', string='Suma Total por Empleado')
    ...
    def _get_payslip_lines(self, contract_ids, payslip_id):
        ...
        # * * * * * * * * * * * * * * * * * * * * * * * * * *
        # * * * Dias Trabajados - Suma Dias Trabajados  * * *
        # * * * * * * * * * * * * * * * * * * * * * * * * * *
...
class HrPayslipLine(models.Model):
    ...
    #sumatoria=fields.Float(devengado='_sumatoria',string='Total Empleado')


    # * * * * * * * * * * * * * * * * * * * * * * * * * *
    # * * * Total por linea de Salary Computation   * * *
    # * * * * * * * * * * * * * * * * * * * * * * * * * *
